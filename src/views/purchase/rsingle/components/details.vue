...
export default {
  ...
  data() {
    return {
      ...
      formArr: [
        { type: 'text', label: '退货单据号', prop: 'documentNum' },
        { type: 'text', label: '退货人姓名', prop: 'createUserName' },
        { type: 'text', label: '退货总数量', prop: 'totalCount' },
        { type: 'text', label: '退货时间', prop: 'createTime' }
      ],
      data: null
    }
  },
